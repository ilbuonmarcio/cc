...
<body>
  ...
  <h3 class="center-align">Benvenuto,
    <i><?php echo $_SESSION["username"]; ?></i>!</h3>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col s12 m6 center-align feature-block">
        ...
        <h5>Visualizza CC</h5>
        <br>
        <em class="feature-block-text"> Visualizza le composizioni classi appena generate attraverso una tabella o esportando un file CSV.
        </em>
      </div>
    </div>
  </div>
